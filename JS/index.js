...
function getDate (date){
    ...
    var dayNumber = nameOfDay.getDate();
    ...
    var monthName = monthNames[nameOfDay.getMonth()];
    
    return {dayNumber:dayNumber , monthName : monthName , dayName:dayName} ;
    }
  ...
  displaySection.innerHTML =  `<div class="col-lg-4">
        ...
        <div class="card w-100 pb-4 ">
                       <div class="card-header d-flex justify-content-between" >
                         <p>${getDate(x.forecast.forecastday[0].date).dayName}</p>
                         <p>${getDate(x.forecast.forecastday[0].date).dayNumber} <span>${getDate(x.forecast.forecastday[0].date).monthName}</span></p>
          ...
          <div class="item">
            <div class="card w-100 pb-5">
              <div class="card-header" >
                <p class="text-center">${getDate(x.forecast.forecastday[1].date).dayName}</p>
              </div>
...
<!-- ="=======================================================""" -->
      <div class="col-lg-4">
        <div class="item">
          <div class="card w-100 pb-5">
            <div class="card-header" >
              <p class="text-center">${getDate(x.forecast.forecastday[2].date).dayName}</p>
            </div>
           <div class="p-4 text-center">
